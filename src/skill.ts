...
// Kept to read-only GitHub outcomes so the skill does not advertise writes,
// secrets, raw API, repo/workflow mutation, or gist deletion by default.
export const SKILL_DESCRIPTION =
  "Read GitHub through the gh-axi CLI - issues, pull requests, stacked PR status, workflow runs, " +
  "releases, repositories, labels, gists, Projects (v2), and search. " +
  "Use for read-only GitHub context: listing or viewing issues and PRs, inspecting CI runs, " +
  "browsing releases or Projects, listing gists, or searching issues, PRs, repos, commits, or code.";
